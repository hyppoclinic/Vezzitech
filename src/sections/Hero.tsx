    ...
    <section className="relative pt-40 pb-24 px-6 overflow-hidden bg-[#070707]">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a 
            href="#consultoria" 
            className="px-8 py-3.5 bg-white hover:bg-gray-100 text-black font-semibold rounded-xl transition duration-300 shadow-xl shadow-[#33BC65]/5 flex items-center gap-2 group cursor-pointer text-sm">
            {t.hero.ctaPrimary} 
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </a>
          <a 
            href="#google" 
            className="px-8 py-3.5 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-semibold rounded-xl transition duration-300 text-sm">
            {t.hero.ctaSecondary}
          </a>
        </div>
