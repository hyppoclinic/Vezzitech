...
export const DifferentiationSection = ({ lang }: { lang: Language }) => {
  ...
  return (
    <section className="py-28 md:py-36 bg-[#070A12] relative overflow-hidden border-t border-white/[0.08]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="rounded-[2rem] bg-[#0B0E1B]/50 backdrop-blur-sm border border-white/[0.08] overflow-hidden shadow-2xl relative"
        >
          {/* Terminal Bar */}
